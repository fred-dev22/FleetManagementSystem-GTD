  ...
  >
    ...
    <template #details-panel="{ item }">
      <div class="flex flex-col gap-3.5">
        ...
        <button :class="L.btnPrimary" class="w-full justify-center" @click="router.push({ name: 'hr-entity-detail', params: { id: item.id } })">Ouvrir la fiche</button>
        <EntityWorkflowActions :entity="item" />
      </div>
    </template>
    ...
    <EntityFormModal v-model="showCreate" />
  </ListPageLayout>
</template>
...
// Le clic sur un nœud (arbre/organigramme) navigue vers la fiche

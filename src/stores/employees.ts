...
const SEED: SeedEmployee[] = [
  ...
  },
  {
    ...
    jobTitle: 'Responsable HSE', role: 'validator',
  ...
  },
  {
    ...
    jobTitle: 'Responsable IT', role: 'validator',
  ...
  },
  {
    ...
    jobTitle: 'Responsable Tracking', role: 'validator',
  ...
  },
  {
    ...
    jobTitle: 'Responsable Maintenance', role: 'validator',
...
export const useEmployeeStore = defineStore('employees', () => {
  ...
  const validatorEmployees = computed(() => employees.value.filter(e =>
    e.role === 'validator' || e.role === 'hr_admin' || e.role === 'hr_director'
  ))

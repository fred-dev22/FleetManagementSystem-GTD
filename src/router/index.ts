...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/fleet/etat-flotte', name: 'fleet-etat-flotte', component: () => import('../views/fleet/EtatFlotteView.vue'), meta: { requiresAuth: true, layout: 'dashboard' } },
    { path: '/fleet/controles', name: 'fleet-controles', component: () => import('../views/fleet/ControlesTechniquesView.vue'), meta: { requiresAuth: true, layout: 'dashboard' } },
    { path: '/fleet/trajets', name: 'fleet-trajets', component: () => import('../views/fleet/TrajetListView.vue'), meta: { requiresAuth: true, layout: 'dashboard' } },
